...
func test_robot_death_animations():
    ...
    assert_true(dummy_creep.DEATH_ANIMATIONS.sprite_frames.has_animation("death_n"), "Robot creep has 'death_n animation'")
    assert_true(dummy_creep.DEATH_ANIMATIONS.sprite_frames.has_animation("death_ne"), "Robot creep has 'death_ne animation'")
    assert_true(dummy_creep.DEATH_ANIMATIONS.sprite_frames.has_animation("death_e"), "Robot creep has 'death_e animation'")
    assert_true(dummy_creep.DEATH_ANIMATIONS.sprite_frames.has_animation("death_se"), "Robot creep has 'death_se animation'")
    assert_true(dummy_creep.DEATH_ANIMATIONS.sprite_frames.has_animation("death_s"), "Robot creep has 'death_s animation'")
    assert_true(dummy_creep.DEATH_ANIMATIONS.sprite_frames.has_animation("death_sw"), "Robot creep has 'death_sw animation'")
    assert_true(dummy_creep.DEATH_ANIMATIONS.sprite_frames.has_animation("death_w"), "Robot creep has 'death_w animation'")
    assert_true(dummy_creep.DEATH_ANIMATIONS.sprite_frames.has_animation("death_nw"), "Robot creep has 'death_nw animation'")

func test_mummy_death_animations():
    # Create dummy creep
    var dummy_creep: Creep = CreepConstants.CreepPreloads[CreepConstants.CreepIDs.MUMMY].instantiate()
    add_child_autofree(dummy_creep)
    dummy_creep.stun(10)

    assert_true(dummy_creep.DEATH_ANIMATIONS.sprite_frames.has_animation("death_n"), "Mummy creep has 'death_n animation'")
    assert_true(dummy_creep.DEATH_ANIMATIONS.sprite_frames.has_animation("death_ne"), "Mummy creep has 'death_ne animation'")
    assert_true(dummy_creep.DEATH_ANIMATIONS.sprite_frames.has_animation("death_e"), "Mummy creep has 'death_e animation'")
    assert_true(dummy_creep.DEATH_ANIMATIONS.sprite_frames.has_animation("death_se"), "Mummy creep has 'death_se animation'")
    assert_true(dummy_creep.DEATH_ANIMATIONS.sprite_frames.has_animation("death_s"), "Mummy creep has 'death_s animation'")
    assert_true(dummy_creep.DEATH_ANIMATIONS.sprite_frames.has_animation("death_sw"), "Mummy creep has 'death_sw animation'")
    assert_true(dummy_creep.DEATH_ANIMATIONS.sprite_frames.has_animation("death_w"), "Mummy creep has 'death_w animation'")
    assert_true(dummy_creep.DEATH_ANIMATIONS.sprite_frames.has_animation("death_nw"), "Mummy creep has 'death_nw animation'")
