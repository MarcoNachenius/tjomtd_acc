...
func test_awaiting_selection_tower_count_dict():
    # ================================================================
    #                     ** CREATE BLANK MAP **
    # ================================================================
    var test_map = GameMap.new()
    ...
    const EXPECTED_VALUE: Dictionary[TowerConstants.TowerIDs, int] = {
    ...
    var simulated_awaiting_selection_towers_list: Array[Tower] = [black_marble_lvl_1, bismuth_lvl_4, black_marble_lvl_1]
    test_map.__towers_awaiting_selection = simulated_awaiting_selection_towers_list

    # Get test value
    var got_value: Dictionary[TowerConstants.TowerIDs, int] = test_map.awaiting_selection_tower_count_dict()

    # Test gotten value
    assert_eq(got_value, EXPECTED_VALUE, "Got expected tower count dict from awaiting_selection_tower_count_dict()")
