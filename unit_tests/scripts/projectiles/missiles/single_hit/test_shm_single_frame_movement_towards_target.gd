...
func test_isometric_movement_south_east():
	...
	single_hit_missile.position = Vector2.ZERO  # Explicitly reset position
	...
	single_hit_missile.set_target(dummy_target)
...
func test_isometric_movement_north_west():
	...
	assert_almost_eq(single_hit_missile.position.x, 0.0, 0.01, "X-coordinate should remain 0.0")
	assert_almost_eq(single_hit_missile.position.y, -15.0, 0.01, "Y-coordinate should be approximately 15.0 (moved up by 15 units).")
	assert_almost_eq(single_hit_missile.__isometric_speed, 15.0, 0.01, "Isometric speed should be near 15")
	assert_eq(single_hit_missile.__velocity, Vector2(0, -1), "Velocity should be (0, -1)")
...
func test_isometric_movement_south_west():
	...
	assert_almost_eq(single_hit_missile.position.y, 0.0, 0.01, "Y-coordinate should remain 0.0")
	...
	assert_almost_eq(single_hit_missile.__isometric_speed, 30.0, 0.01, "Isometric speed should be near 30")
	assert_eq(single_hit_missile.__velocity, Vector2(-1, 0), "Velocity should be (-1, 0)")
...
func test_isometric_movement_north_east():
	...
	assert_almost_eq(single_hit_missile.position.y, 0.0, 0.01, "Y-coordinate should remain 0.0")
	assert_almost_eq(single_hit_missile.position.x, 30.0, 0.01, "X-coordinate should be approximately 30.0 (moved right by 30 units).")
	assert_almost_eq(single_hit_missile.__isometric_speed, 30.0, 0.01, "Isometric speed should be near 30")
	assert_eq(single_hit_missile.__velocity, Vector2(1, 0), "Velocity should be (1, 0)")
...
func test_isometric_movement_north():
	...
	assert_almost_eq(single_hit_missile.position.y, -18.106, 0.01, "Y-coordinate should be approximately -18.106 (moved up by 18.106 units).")
	assert_almost_eq(single_hit_missile.position.x, 18.106, 0.01, "X-coordinate should be approximately 18.106 (moved right by 18.106 units).")

	# Evaluate the missile's isometric speed
	assert_almost_eq(single_hit_missile.__isometric_speed, 25.6065, 0.01, "Isometric speed should be near 25.6065")

	# Evaluate the missile's velocity
	assert_almost_eq(single_hit_missile.__velocity.x, 0.7071, 0.01, "Velocity.x should be ~0.7071 for rightwards movement.")
	assert_almost_eq(single_hit_missile.__velocity.y, -0.7071, 0.01, "Velocity.y should be ~0.7071 for upwards movement.")
...
func test_isometric_movement_south():
	...
	assert_almost_eq(single_hit_missile.position.y, 18.106, 0.01, "Y should be approximately 18.106 (moved down).")
	assert_almost_eq(single_hit_missile.position.x, -18.106, 0.01, "X should be approximately -18.106 (moved left).")

	assert_almost_eq(single_hit_missile.__velocity.x, -0.7071, 0.01, "Velocity.x should be ~-0.7071 for leftwards movement.")
	assert_almost_eq(single_hit_missile.__velocity.y, 0.7071, 0.01, "Velocity.y should be ~0.7071 for downwards movement.")
...
func test_isometric_movement_east():
	...
	assert_almost_eq(single_hit_missile.position.y, 18.106, 0.01, "Y should be approximately 18.106 (moved down).")
	assert_almost_eq(single_hit_missile.position.x, 18.106, 0.01, "X should be approximately 18.106 (moved right).")
...
func test_isometric_movement_west():
	...
	assert_almost_eq(single_hit_missile.position.y, -18.106, 0.01, "Y should be approximately -18.106 (moved up).")
	assert_almost_eq(single_hit_missile.position.x, -18.106, 0.01, "X should be approximately -18.106 (moved left).")
