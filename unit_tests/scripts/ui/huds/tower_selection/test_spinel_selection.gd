...
func test_spinel_lvl_1_selection():
    # ================================================================
    #                     ** CREATE BLANK MAP **
    # ================================================================
    ...
    var test_towers_awaiting_selection: Array[Tower] = [spinel_lvl_1]
    test_game_map.__towers_awaiting_selection = test_towers_awaiting_selection

    assert_not_null(spinel_lvl_1.PRIMARY_PROJECTILE_SPAWNER, "Tower has primary projectile spawner assigned.")
...
func test_spinel_lvl_2_selection():
    # ================================================================
    #                     ** CREATE BLANK MAP **
    # ================================================================
    var test_game_map = GameMap.new()
    ...
    # Create simulated list of towers and assign to game map
    var test_towers_awaiting_selection: Array[Tower] = [spinel_lvl_2]
    test_game_map.__towers_awaiting_selection = test_towers_awaiting_selection

    assert_not_null(spinel_lvl_2.PRIMARY_PROJECTILE_SPAWNER, "Tower has primary projectile spawner assigned.")

    # Simulate tower being selected
    test_game_map.tower_selected.emit(spinel_lvl_2)
...
func test_spinel_lvl_3_selection():
    # ================================================================
    #                     ** CREATE BLANK MAP **
    # ================================================================
    var test_game_map = GameMap.new()
    ...
    # Create simulated list of towers and assign to game map
    var test_towers_awaiting_selection: Array[Tower] = [spinel_lvl_3]
    test_game_map.__towers_awaiting_selection = test_towers_awaiting_selection

    assert_not_null(spinel_lvl_3.PRIMARY_PROJECTILE_SPAWNER, "Tower has primary projectile spawner assigned.")

    # Simulate tower being selected
    test_game_map.tower_selected.emit(spinel_lvl_3)
...
func test_spinel_lvl_4_selection():
    # ================================================================
    #                     ** CREATE BLANK MAP **
    # ================================================================
    var test_game_map = GameMap.new()
    ...
    # Create simulated list of towers and assign to game map
    var test_towers_awaiting_selection: Array[Tower] = [spinel_lvl_4]
    test_game_map.__towers_awaiting_selection = test_towers_awaiting_selection

    assert_not_null(spinel_lvl_4.PRIMARY_PROJECTILE_SPAWNER, "Tower has primary projectile spawner assigned.")

    # Simulate tower being selected
    test_game_map.tower_selected.emit(spinel_lvl_4)
...
func test_spinel_lvl_5_selection():
    # ================================================================
    #                     ** CREATE BLANK MAP **
    # ================================================================
    var test_game_map = GameMap.new()
    ...
    # Create towers required for upgrade to tombstone
    var spinel_lvl_5: Tower = TowerConstants.BUILD_TOWER_PRELOADS[TowerConstants.TowerIDs.SPINEL_LVL_5].instantiate()
    test_game_map.add_child(spinel_lvl_5)

    # Create simulated list of towers and assign to game map
    var test_towers_awaiting_selection: Array[Tower] = [spinel_lvl_5]
    test_game_map.__towers_awaiting_selection = test_towers_awaiting_selection

    assert_not_null(spinel_lvl_5.PRIMARY_PROJECTILE_SPAWNER, "Tower has primary projectile spawner assigned.")

    # Simulate tower being selected
    test_game_map.tower_selected.emit(spinel_lvl_5)
