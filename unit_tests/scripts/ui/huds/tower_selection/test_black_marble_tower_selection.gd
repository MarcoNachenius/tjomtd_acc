...
func test_black_marble_lvl_1_selection():
    # ================================================================
    #                     ** CREATE BLANK MAP **
    # ================================================================
    ...
    var test_towers_awaiting_selection: Array[Tower] = [black_marble_lvl_1]
...
func test_black_marble_lvl_2_selection():
    # ================================================================
    #                     ** CREATE BLANK MAP **
    # ================================================================
    var test_game_map = GameMap.new()
    ...
    # Create simulated list of towers and assign to game map
    var test_towers_awaiting_selection: Array[Tower] = [black_marble_lvl_2]
    test_game_map.__towers_awaiting_selection = test_towers_awaiting_selection

    assert_not_null(black_marble_lvl_2.PRIMARY_PROJECTILE_SPAWNER, "Tower has primary projectile spawner assigned.")
...
func test_black_marble_lvl_3_selection():
    # ================================================================
    #                     ** CREATE BLANK MAP **
    # ================================================================
    var test_game_map = GameMap.new()
    ...
    # Create simulated list of towers and assign to game map
    var test_towers_awaiting_selection: Array[Tower] = [black_marble_lvl_3]
    test_game_map.__towers_awaiting_selection = test_towers_awaiting_selection

    assert_not_null(black_marble_lvl_3.PRIMARY_PROJECTILE_SPAWNER, "Tower has primary projectile spawner assigned.")
...
func test_black_marble_lvl_4_selection():
    # ================================================================
    #                     ** CREATE BLANK MAP **
    # ================================================================
    var test_game_map = GameMap.new()
    ...
    # Create simulated list of towers and assign to game map
    var test_towers_awaiting_selection: Array[Tower] = [black_marble_lvl_4]
    test_game_map.__towers_awaiting_selection = test_towers_awaiting_selection

    assert_not_null(black_marble_lvl_4.PRIMARY_PROJECTILE_SPAWNER, "Tower has primary projectile spawner assigned.")

    # Simulate tower being selected
    test_game_map.tower_selected.emit(black_marble_lvl_4)
...
func test_black_marble_lvl_5_selection():
    # ================================================================
    #                     ** CREATE BLANK MAP **
    # ================================================================
    var test_game_map = GameMap.new()
    ...
    # Create towers required for upgrade to tombstone
    var black_marble_lvl_5: Tower = TowerConstants.BUILD_TOWER_PRELOADS[TowerConstants.TowerIDs.BLACK_MARBLE_LVL_5].instantiate()
    test_game_map.add_child(black_marble_lvl_5)

    # Create simulated list of towers and assign to game map
    var test_towers_awaiting_selection: Array[Tower] = [black_marble_lvl_5]
    test_game_map.__towers_awaiting_selection = test_towers_awaiting_selection

    assert_not_null(black_marble_lvl_5.PRIMARY_PROJECTILE_SPAWNER, "Tower has primary projectile spawner assigned.")

    # Simulate tower being selected
    test_game_map.tower_selected.emit(black_marble_lvl_5)
