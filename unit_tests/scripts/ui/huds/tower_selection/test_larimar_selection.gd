...
func test_larimar_lvl_1_selection():
    # ================================================================
    #                     ** CREATE BLANK MAP **
    # ================================================================
    ...
    var test_towers_awaiting_selection: Array[Tower] = [larimar_lvl_1]
    test_game_map.__towers_awaiting_selection = test_towers_awaiting_selection

    assert_not_null(larimar_lvl_1.PRIMARY_PROJECTILE_SPAWNER, "Tower has primary projectile spawner assigned.")

    # Simulate tower being selected
    test_game_map.tower_selected.emit(larimar_lvl_1)
...
func test_larimar_lvl_2_selection():
    # ================================================================
    #                     ** CREATE BLANK MAP **
    # ================================================================
    var test_game_map = GameMap.new()
    ...
    # Create simulated list of towers and assign to game map
    var test_towers_awaiting_selection: Array[Tower] = [larimar_lvl_2]
    test_game_map.__towers_awaiting_selection = test_towers_awaiting_selection

    assert_not_null(larimar_lvl_2.PRIMARY_PROJECTILE_SPAWNER, "Tower has primary projectile spawner assigned.")

    # Simulate tower being selected
    test_game_map.tower_selected.emit(larimar_lvl_2)
...
func test_larimar_lvl_3_selection():
    # ================================================================
    #                     ** CREATE BLANK MAP **
    # ================================================================
    var test_game_map = GameMap.new()
    ...
    # Create simulated list of towers and assign to game map
    var test_towers_awaiting_selection: Array[Tower] = [larimar_lvl_3]
    test_game_map.__towers_awaiting_selection = test_towers_awaiting_selection

    assert_not_null(larimar_lvl_3.PRIMARY_PROJECTILE_SPAWNER, "Tower has primary projectile spawner assigned.")

    # Simulate tower being selected
    test_game_map.tower_selected.emit(larimar_lvl_3)
...
func test_larimar_lvl_4_selection():
    # ================================================================
    #                     ** CREATE BLANK MAP **
    # ================================================================
    var test_game_map = GameMap.new()
    ...
    # Create towers required for upgrade to tombstone
    var larimar_lvl_4: Tower = TowerConstants.BUILD_TOWER_PRELOADS[TowerConstants.TowerIDs.LARIMAR_LVL_4].instantiate()
    test_game_map.add_child(larimar_lvl_4)

    # Create simulated list of towers and assign to game map
    var test_towers_awaiting_selection: Array[Tower] = [larimar_lvl_4]
    test_game_map.__towers_awaiting_selection = test_towers_awaiting_selection

    assert_not_null(larimar_lvl_4.PRIMARY_PROJECTILE_SPAWNER, "Tower has primary projectile spawner assigned.")

    # Simulate tower being selected
    test_game_map.tower_selected.emit(larimar_lvl_4)
    ...
    test_game_map.queue_free()
    test_random_tower_build_hud.queue_free()
    larimar_lvl_4.queue_free()
    # Process frame to ensure all objects are cleaned up
    await get_tree().process_frame

func test_larimar_lvl_5_selection():
    # ================================================================
    #                     ** CREATE BLANK MAP **
    # ================================================================
    var test_game_map = GameMap.new()
    ...
    # Create towers required for upgrade to tombstone
    var larimar_lvl_5: Tower = TowerConstants.BUILD_TOWER_PRELOADS[TowerConstants.TowerIDs.LARIMAR_LVL_5].instantiate()
    test_game_map.add_child(larimar_lvl_5)

    # Create simulated list of towers and assign to game map
    var test_towers_awaiting_selection: Array[Tower] = [larimar_lvl_5]
    test_game_map.__towers_awaiting_selection = test_towers_awaiting_selection

    assert_not_null(larimar_lvl_5.PRIMARY_PROJECTILE_SPAWNER, "Tower has primary projectile spawner assigned.")

    # Simulate tower being selected
    test_game_map.tower_selected.emit(larimar_lvl_5)
