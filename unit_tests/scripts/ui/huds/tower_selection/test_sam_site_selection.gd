...
func test_sam_site_lvl_1_selection():
	...
	# Create towers required for upgrade to sam_site
	var sam_site_lvl_1: Tower = TowerConstants.UPGRADE_TOWER_PRELOADS[TowerConstants.UpgradeTowerIDs.SAM_SITE_LVL_1].instantiate()
...
func test_sam_site_lvl_2_selection():
	...
	# Create towers required for upgrade to sam_site
	var sam_site_lvl_2: Tower = TowerConstants.UPGRADE_TOWER_PRELOADS[TowerConstants.UpgradeTowerIDs.SAM_SITE_LVL_2].instantiate()
...
func test_sam_site_lvl_3_selection():
	# ================================================================
	#                     ** CREATE BLANK MAP **
	# ================================================================
	var test_game_map = GameMap.new()
	...
	# Create towers required for upgrade to sam_site
	var sam_site_lvl_3: Tower = TowerConstants.UPGRADE_TOWER_PRELOADS[TowerConstants.UpgradeTowerIDs.SAM_SITE_LVL_3].instantiate()
	test_game_map.add_child(sam_site_lvl_3)
	sam_site_lvl_3.switch_state(Tower.States.BUILT)

	# Create simulated list of towers and assign to game map
	var test_towers_awaiting_selection: Array[Tower] = [sam_site_lvl_3]
	test_game_map.__towers_on_map = test_towers_awaiting_selection

	assert_not_null(sam_site_lvl_3.PRIMARY_PROJECTILE_SPAWNER, "Tower has primary projectile spawner assigned.")

	# Simulate tower being selected
	test_game_map.tower_selected.emit(sam_site_lvl_3)
