...
func test_shm_launch_north_west():
    # ==================
    # CREATE DUMMY CREEP
    # ==================
    ...
    # =====================
    var missile_spawner = SingleMissileSpawner.new()
    ...
    var found_missile: SingleHitMissile
...
func test_shm_launch_south_east():
    # ==================
    # CREATE DUMMY CREEP
    # ==================
    var dummy_target = CreepConstants.CreepPreloads[CreepConstants.CreepIDs.DEMON].instantiate()
...
func test_shm_launch_south_west():
    # ==================
    # CREATE DUMMY CREEP
    # ==================
    var dummy_target = CreepConstants.CreepPreloads[CreepConstants.CreepIDs.DEMON].instantiate()
...
func test_shm_launch_north_east():
    # ==================
    # CREATE DUMMY CREEP
    # ==================
    var dummy_target = CreepConstants.CreepPreloads[CreepConstants.CreepIDs.DEMON].instantiate()
