...
func test_spawner_with_two_targets_per_launch_with_two_targets_in_range():
    ...
    # =====================
    var missile_spawner = MultiTargetSingleHitMissileSpawner.new()
    missile_spawner.__missile_damage = 10
    missile_spawner.__missile_speed = 10
    missile_spawner.MISSILE_PRELOAD = ProjectileConstants.SingleHitMissiles.BISMUTH_LVL_1
    ...
    # ==============
    # Create search vars
    var found_missiles: Array[SingleHitMissile]

    # Search for relevant values
    for child in missile_spawner.get_children():
        if child is SingleHitMissile:
    ...
    var first_launched_missile: SingleHitMissile = found_missiles[0]
    var second_launched_missile: SingleHitMissile = found_missiles[1]
