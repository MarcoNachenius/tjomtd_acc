...
func _connect_menu_change_buttons_signals() -> void:
	...
	TOWER_AND_SLATE_INFO_BUTTON.pressed.connect(_on_tower_slate_info_button_pressed)
...
func _on_tower_slate_info_button_pressed() -> void:
