...
func _on_sharp_shooter_lvl_2_button_pressed():
	CONNECTED_MAIN_HUB.handle_extended_upgrade(TowerConstants.UpgradeTowerIDs.SHARP_SHOOTER_LVL_2)

func _on_tombstone_lvl_2_button_pressed():
	CONNECTED_MAIN_HUB.handle_extended_upgrade(TowerConstants.UpgradeTowerIDs.TOMBSTONE_LVL_2)

func _on_tombstone_lvl_3_button_pressed():
	CONNECTED_MAIN_HUB.handle_extended_upgrade(TowerConstants.UpgradeTowerIDs.TOMBSTONE_LVL_3)

func _on_sam_site_lvl_2_button_pressed():
	CONNECTED_MAIN_HUB.handle_extended_upgrade(TowerConstants.UpgradeTowerIDs.SAM_SITE_LVL_2)

func _on_sam_site_lvl_3_button_pressed():
	CONNECTED_MAIN_HUB.handle_extended_upgrade(TowerConstants.UpgradeTowerIDs.SAM_SITE_LVL_3)

func _on_lava_pool_lvl_2_button_pressed():
	CONNECTED_MAIN_HUB.handle_extended_upgrade(TowerConstants.UpgradeTowerIDs.LAVA_POOL_LVL_2)

func _on_lava_pool_lvl_3_button_pressed():
	CONNECTED_MAIN_HUB.handle_extended_upgrade(TowerConstants.UpgradeTowerIDs.LAVA_POOL_LVL_3)

func _on_ice_shard_lvl_2_button_pressed():
	CONNECTED_MAIN_HUB.handle_extended_upgrade(TowerConstants.UpgradeTowerIDs.ICE_SHARD_LVL_2)

func _on_ice_shard_lvl_3_button_pressed():
	CONNECTED_MAIN_HUB.handle_extended_upgrade(TowerConstants.UpgradeTowerIDs.ICE_SHARD_LVL_3)

func _on_emp_stunner_lvl_2_button_pressed():
	CONNECTED_MAIN_HUB.handle_extended_upgrade(TowerConstants.UpgradeTowerIDs.EMP_STUNNER_LVL_2)

func _on_emp_stunner_lvl_3_button_pressed():
	CONNECTED_MAIN_HUB.handle_extended_upgrade(TowerConstants.UpgradeTowerIDs.EMP_STUNNER_LVL_3)

func _on_gatling_gun_lvl_2_button_pressed():
	CONNECTED_MAIN_HUB.handle_extended_upgrade(TowerConstants.UpgradeTowerIDs.GATLING_GUN_LVL_2)
